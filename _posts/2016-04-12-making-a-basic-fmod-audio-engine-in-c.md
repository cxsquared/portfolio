...
The first two functions we'll add are the **Init** and **Update** funcitons which are super simple. We just need to create the **Implementation** and call its update.
